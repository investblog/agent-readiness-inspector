...
Zu jeder fehlgeschlagenen Prüfung gehört die Behebung: was der Standard verlangt, die Änderung für den Stack, auf dem die Seite zu laufen scheint (Cloudflare, Vercel, Netlify, nginx, Next.js), und der eine Befehl, der zeigt, dass sie greift.
